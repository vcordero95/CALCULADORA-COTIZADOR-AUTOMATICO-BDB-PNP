...
1. **Costo variable** = Costo de gasolina por km (según tipo de unidad) × kilómetros de la ruta.
2. **Costo fijo mensual** = Sueldo + Renta de la unidad (según tipo de unidad).
...
5. Menú **Cotizador BDB → Inicializar hojas**. Esto crea:
   - **Hoja Maestra**: catálogo de tipos de unidad con sueldo, gasolina/km y renta.
